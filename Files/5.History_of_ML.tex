...
\end{equation}
         ...
         \begin{figure}[H] 
        \centering\includegraphics[scale=0.3]{3.Scheme of a perceptron.jpeg}
...
No matter how you rotate, tilt, or shift a single straight line on that graph, \textbf{it is geometrically impossible} to separate the two 1s from the two 0s. Because the data is not \textit{linearly separable}, the single perceptron utterly fails. 
         ...
         \begin{figure}[H] 
        \centering\includegraphics[scale=0.45]{4.Perceptron problem.jpeg}
        \caption{XOR Problem}
    \captionsetup{font=footnotesize}
    \end{figure}
...
\end{itemize}
         ...
         \begin{figure}[H] 
        \centering\includegraphics[scale=0.3]{5.Self organizing maps (SOMs).jpeg}
