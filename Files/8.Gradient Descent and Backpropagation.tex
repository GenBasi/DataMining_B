...
\begin{itemize}
    ...
    \item \textbf{Backpropagation: concetti fondamentali}
    \begin{itemize}
        \item Introduzione alla sezione sul backpropagation algorithm (slide 19)
        \item Definizione, ruolo storico e collegamento con automatic differentiation (slide 20)
        \item Forward phase e backward phase nelle reti neurali viste come computational graphs (slide 21)
    \end{itemize}

    \item \textbf{Notazione matematica per la backpropagation}
    \begin{itemize}
        \item Attivazioni dei neuroni in forma scalare e matriciale (slide 22)
        \item Weighted input $z^l$, relazione tra $z^l$ e $a^l$ (slide 23)
        \item Assunzioni sulla cost function necessarie per applicare backpropagation (slide 24)
        \item Giustificazione della prima assunzione e passaggio al singolo training example (slide 25)
        \item Esempio con quadratic cost function e verifica delle assunzioni (slide 26)
    \end{itemize}

    \item \textbf{Le quattro equazioni fondamentali della Backpropagation}
    \begin{itemize}
        \item Introduzione alla sezione sulle quattro equazioni fondamentali (slide 27)
        \item Definizione dell’errore del neurone $\delta_j^l$ (slide 28)
        \item BP1: errore nello strato di output (slide 29)
        \item Forma matriciale di BP1 e caso della quadratic cost (slide 30)
        \item Dimostrazione di BP1 tramite chain rule (slide 31)
        \item BP2: propagazione dell’errore allo strato precedente (slide 32)
        \item BP3: derivata della cost rispetto ai bias (slide 33)
        \item BP4: derivata della cost rispetto ai pesi (slide 34)
        \item Riassunto compatto delle quattro equazioni BP1--BP4 (slide 35)
    \end{itemize}

    \item \textbf{Implicazioni della Backpropagation e dinamica dell’apprendimento}
    \begin{itemize}
        \item Conseguenze pratiche delle equazioni BP: neuroni saturi, gradienti piccoli, apprendimento lento (slide 36)
        \item Algoritmo completo della backpropagation passo per passo (slide 37)
    \end{itemize}

    \item \textbf{Combinare Gradient Descent e Backpropagation}
    \begin{itemize}
        \item Introduzione alla sezione sulla combinazione GD + BP (slide 38)
        \item Procedura pratica per combinare feedforward, backpropagation e gradient descent su mini-batch (slide 39)
    \end{itemize}

    \item \textbf{Interpretazione intuitiva della Backpropagation e problemi dei gradienti}
    \begin{itemize}
        \item Logica intuitiva della BP: come una piccola variazione di un peso influenza la cost (slide 40)
        \item Propagazione delle variazioni attraverso le attivazioni del layer successivo (slide 41)
        \item Somma dei contributi lungo tutti i possibili cammini nella rete (slide 42)
        \item Espansione della chain rule lungo un intero percorso dalla weight alla cost (slide 43)
        \item Vanishing gradient problem e impatto sull’aggiornamento dei pesi (slide 44)
        \item Altri problemi dell’addestramento profondo: exploding gradients, difficoltà di convergenza, minimi spurii (slide 45)
    \end{itemize}

    \item \textbf{Esercizi finali}
    \begin{itemize}
        \item Esercizi su dimostrazione di BP2, BP3, BP4 e varianti della backpropagation (slide 46)
    \end{itemize}
\end{itemize}
...
\begin{figure}[H] 
    \centering\includegraphics[scale=0.75]{12.The Cost Hypersuperface.jpg}
...
\begin{figure}[H] 
    \centering\includegraphics[scale=0.75]{13.Different path for the minimum.jpg}
...
\begin{figure}[H] 
    \centering\includegraphics[scale=0.75]{14.Filter Normalization.jpg}
...
\begin{figure}[H] 
    \centering\includegraphics[scale=0.6]{15.Loss Validation vs Training set.jpg}
